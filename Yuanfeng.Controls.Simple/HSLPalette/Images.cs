...
namespace Yuanfeng.Controls.Palette
{
    class ImagesUtil
    {
        ...
        static public ImageList GetToolbarImageList(Type type, Size imageSize, Color transparentColor)
        {
            System.Drawing.Bitmap bitmap = Simple.Properties.Resources.colorbarIndicators;
            ImageList imageList = new ImageList();
            imageList.ImageSize = imageSize;
            imageList.TransparentColor = transparentColor;
            imageList.Images.AddStrip(bitmap);
    ...
    class SelectorImages
    {
        ...
        static public ImageList ImageList()
        {
            ...
            if (m_imageList == null)
                m_imageList = ImagesUtil.GetToolbarImageList(t, new Size(12, 12), Color.Magenta);
            return m_imageList;
        }
        ...
        static public Image GetColorPoint()
        {
            System.Drawing.Bitmap bitmap = Simple.Properties.Resources.colorPoint; //new System.Drawing.Bitmap(typeof(SelectorImages), " Simple.Properties.Resources.colorPoint");
            return bitmap;
        }
    }
}
